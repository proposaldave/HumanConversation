...
test("the public landing page tells one verified Twitter, Slack, and Human Conversation story", async () => {
  ...
  assert.deepEqual(state, {
    ...
    humanSupport: "Every important system needs to understand what’s happening — and know what to do next.",
    humanMarkParts: 3,
    dataSentence: "",
    twist: "",
    followArrow: true,
...
test("the public story resolves the twist with the existing interface thesis", async () => {
  ...
  assert.equal(firstPanel.bodyText, "For decades, technology has pulled communication onto interfaces. We’re doing the opposite.");
