...
test("the public landing page tells one verified Twitter, Slack, and Human Conversation story", async () => {
  ...
  assert.deepEqual(state, {
    ...
    humanSupport: "Every complex system needs to understand the truth about what’s happening — so it knows what to do next.",
    humanMarkParts: 3,
    dataSentence: "",
    twist: "",
    followArrow: true,
