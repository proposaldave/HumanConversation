...
test("the public landing page tells one verified Twitter, Slack, and Human Conversation story", async () => {
  ...
  assert.deepEqual(state, {
    ...
    humanSupport: "Every important human system needs to understand what’s happening — and know what to do next.",
    humanMarkParts: 3,
    dataSentence: "",
    twist: "",
    followArrow: true,
