...
test("the public Human Conversation question leads into a smaller present-state line above the continuation cue", async () => {
  const expectedQuestion = "What’s happening within us, between us, and around us?";
  const expectedSupport = "Every important human system needs a way to see the truth of what’s happening within it.";
