...
test("the public landing page tells one verified Twitter, Slack, and Human Conversation story", async () => {
  ...
  assert.deepEqual(state, {
    ...
    heroLabel:
      "2009. Twitter. Digital Communities, solved. What’s happening around the world? Approximately 6 trillion dollars of public-company value behind digital social. 2014. Slack. Organizations, solved. What’s happening inside the organization? Approximately 7 trillion dollars of public-company value behind organizational communication. 2026. Human Conversation. Real-world social communities, unsolved. What’s happening in our communities? Every important human system needs a way to understand its present state.",
    contactDisplay: "none",
    storyHidden: false,
    storySections: 12,
    demoCount: 0,
